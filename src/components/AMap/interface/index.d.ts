declare global {
  namespace AMap {
     ...
     * @private
     */
    abstract class CombinePolygon<T = any> extends VectorOverlay implements IVectorOverlay {
      hide(): void;
      show(): void;
     ...
     * @private
     */
    abstract class CombinePolyline extends VectorOverlay {
      hide(): void;
      show(): void;
     ...
     * @public
     */
    class DistrictLayer_2 extends TileLayer {
      CLASS_NAME: string;
    }
    ...
    export interface IGeometryUtil {
       ...
       * @memberof GeometryUtil
       */
      isPointInRing(p: AMap.LngLatLike, ring: string): boolean;
      /**
       * 判断环是否在另一个环内
       *
       * @param {LngLatLike[]} ring1
    ...
    class Map_2 extends CoreMap {
       ...
       */
      setFitView(overlays?: Overlay[], immediately?: boolean, avoid?: number[], maxZoom?: number): Bounds | undefined;
      /**
    ...
    export class RangingTool {
      constructor(map: Map_2, rulerOptions?: any);
    }
    ...
    export class MouseTool {
      ...
      rule(options: PolylineOptions): void;
    ...
    export class PolyEditor {
      constructor(map: Map_2 | null, object: any);
    ...
    export class MarkerClusterer {
      constructor(map: Map_2 | null, object: any, opts?: any);

      getMarkers(): any;

      on(click: string, param2: (obj: any) => void): void;
